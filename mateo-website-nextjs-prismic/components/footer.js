      ...
      <Container>
        <div className="py-28 flex flex-col items-start">
          ...
          <div className="mb-32">
            ...
            >
            <FontAwesomeIcon className="mr-5 text-4xl lg:text-5xl text-white" icon={faTwitter} />
            </a>
            <a
                href={`https://instagram.com/mateo.estate`}
                className="hover:underline hover:pointer mb-1 text-white"
            >
            <FontAwesomeIcon className="mr-5 text-4xl lg:text-5xl text-white" icon={faInstagram} />
            </a>
            <a
                href={`https://facebook.com/mateoestate`}
                className="hover:underline hover:pointer mb-1 text-white"
            >
            <FontAwesomeIcon className="mr-5 text-4xl lg:text-5xl text-white" icon={faFacebook} />
            </a>
            <a
                href={`https://linkedin.com/company/mateoestate`}
                className="hover:underline hover:pointer mb-1 text-white"
            >
            <FontAwesomeIcon className="mr-5 text-4xl lg:text-5xl text-white" icon={faLinkedin} />
            </a>
          </div>
