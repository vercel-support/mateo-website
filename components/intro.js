    ...
    <>
      <section className="flex-col items-center md:justify-between mt-16 mb-32 sm:mt-32 sm:mb-32">
        ...
        <h4 className="mt-8 text-base sm:mt-8 sm:text-lg sm:mx-auto md:mt-8 md:text-3xl lg:mx-0">
          ...
          Mieterinteraktion. Wir helfen Vermietern dabei, Mieter und Mitarbeiter
          zu begeistern.
        </h4>
        <form>
      ...
      <section className="flex-col items-center md:justify-between text-left md:text-center mt-32 mb-32 sm:mt-64 sm:mb-64">
        ...
        <h4 className="mt-8 text-base sm:mt-3 sm:text-2xl sm:mx-auto md:mt-3 md:text-5xl lg:mx-0">
          Eine kompromisslos gute Immobiliensoftware. Speziell für produktivere
          Mitarbeiter & glückliche Mieter.
        </h4>
      </section>
        ...
        <div className="flex flex-col-reverse sm:flex-row items-center">
          ...
          <div>
            ...
            <h4 className="mt-3 text-base sm:mt-8 sm:text-lg sm:mx-auto md:mt-3 md:text-3xl lg:mx-0">
              ...
              dazugehörige Dokumente. Alle Informationen 100 % Digital und mobil
      ...
      <section className="flex-col items-center md:justify-between mt-32 mb-32 sm:mt-64 sm:mb-64">
        <div className="flex flex-col sm:flex-row items-center">
          <div className="">
            ...
            <h4 className="mt-3 text-base sm:mt-8 sm:text-lg sm:mx-auto md:mt-3 md:text-3xl lg:mx-0">
              Mit MATEO Home haben Mieter umfassende Self Service Möglichkeiten
              und eine transparente Übersicht zu allen Anfragen. Zusätzlich gibt
              es auf dem MATEO Marketplace weitere attraktive und nützliche
              Services.
            </h4>
          </div>
          <div className=" pt-10 sm:pt-0 sm:pl-16 text-base sm:text-lg sm:mx-auto md:text-xl lg:mx-0">
